...
const beneficios: Beneficio[] = [
  {
    ...
    texto:
      "Menos papel e contratações muito mais rápidas.",
  },
  {
    icone: <IconeCadastro />,
    titulo: "Cadastro único",
    texto:
      "O fornecedor preenche uma vez; a empresa acessa sempre atualizado.",
  },
  {
    icone: <IconeStatus />,
    titulo: "Status em tempo real",
    texto:
      "Transparência total para os dois lados acompanharem o processo.",
  },
  {
    icone: <IconeMaleta />,
    titulo: "Fim do retrabalho",
    texto:
      "Filtros automáticos eliminam vai e vem de documentos errados.",
  },
  {
    icone: <IconeCadeado />,
    titulo: "Segurança e compliance",
    texto:
      "Histórico imutável e auditável para segurança jurídica e fiscal.",
  },
  {
    icone: <IconeEscudo />,
    titulo: "Proteção contra riscos",
    texto:
      "Dados protegidos pela LGPD e segurança corporativa contra fraudes.",
  },
];
...
export function SecaoBeneficios(): JSX.Element {
  ...
  useEffect(() => {
    ...
    function atualizarScrollDriven(): void {
      ...
      const topoDaSecao =
        secao.offsetTop +
        OFFSET_ENTRADA_SECAO;
      const inicioTravamento =
        topoDaSecao - ALTURA_CABECALHO;
      const fimTravamento =
        inicioTravamento +
        alturaScrollInterno;
      ...
      >
        <div className="mx-auto max-w-[720px]">
          ...
          <p className="mt-5 text-base font-medium leading-7 text-[#171826] sm:text-lg">
            Transforme o credenciamento
            médico em um processo mais
            organizado, rastreável e
            eficiente. Centralize
            validações, reduza
            retrabalho e acompanhe cada
            etapa com mais controle
            operacional.
          </p>
            ...
            {beneficios.map(
              (beneficio) => (
                <article
                  ...
                  className="relative overflow-hidden rounded-2xl border border-[#d8dbea] bg-white px-5 py-4 shadow-[0_16px_34px_rgba(15,23,42,0.07)]"
                >
                  <span className="pointer-events-none absolute right-3 top-3 flex h-16 w-16 items-center justify-center text-hss-roxo opacity-[0.08] [&>svg]:h-full [&>svg]:w-full">
                    {beneficio.icone}
                  </span>
                  <h3 className="relative pr-12 text-lg font-black leading-tight text-[#070814]">
                    {beneficio.titulo}
                  </h3>
                  <p className="relative mt-2 hyphens-auto text-sm font-medium leading-6 text-[#1f2937]">
                    {beneficio.texto}
                  </p>
                </article>
              ),
      ...
      >
        <div className="mx-auto grid h-[calc(100vh-74px)] max-w-[1110px] items-center gap-12 overflow-hidden px-4 sm:px-6 lg:grid-cols-[0.72fr_1.28fr] lg:px-2">
          ...
          <div className="self-center">
            <h2 className="max-w-[450px] text-[2.5rem] font-black leading-[1.12] tracking-[0.01em] text-[#070814] sm:text-[3.1rem]">
              Benefícios da nossa
              solução
            </h2>
            ...
            <p className="mt-7 max-w-[460px] text-lg font-medium leading-8 text-[#171826]">
              Transforme o
              credenciamento médico em
              um processo mais
              organizado, rastreável e
              eficiente. Centralize
              validações, reduza
              retrabalho e acompanhe
              cada etapa com mais
              ...
              (beneficio, indice) => {
                ...
                return (
                  <article
                    ...
                    className={[
                      "relative min-h-[150px] overflow-hidden rounded-2xl border border-[#d8dbea] bg-white px-5 py-4",
                  ...
                  >
                    ...
                    <h3 className="relative pr-12 text-xl font-black leading-tight text-[#070814]">
                      {beneficio.titulo}
                    </h3>
