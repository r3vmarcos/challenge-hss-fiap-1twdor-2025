...
export function SecaoBeneficios(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      >
        <div className="mx-auto grid h-[calc(100vh-74px)] max-w-[1110px] items-center gap-12 overflow-hidden px-4 sm:px-6 lg:grid-cols-[0.72fr_1.28fr] lg:px-8">
          ...
          <div className="grid min-h-[560px] content-center gap-5 sm:grid-cols-2 xl:grid-cols-3">
            {beneficios.map(
              (beneficio, indice) => {
                const visivel =
                  indice <
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="mt-2 text-xl font-black leading-tight text-[#070814]">
                      {beneficio.titulo}
                    </h3>

                    <p className="mt-3 text-sm font-medium leading-6 text-[#1f2937]">
                      {beneficio.texto}
                    </p>
                  </article>
                );
