    ...
    <footer className="relative z-10 border-t border-[#d7d9e6] bg-[#eef0f7] px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-[1110px] gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div>
          ...
          <p className="mt-5 max-w-[620px] text-sm font-medium leading-6 text-slate-600">Health Sync Solutions - FIAP MedTech Challenge.</p>
          <p className="mt-3 text-xs font-semibold text-slate-500">© 2026 Health Sync Solutions. Todos os direitos reservados.</p>
          <p className="mt-3 text-xs font-semibold text-slate-500">© 2026 FIAP. Todos os direitos reservados.</p>
        </div>
